...
// premiers-pas.rs
//
// Dans cet exercices vous allez découvrir les commentaires, faire votre premier
// programme il sera très simple, il ne fera rien!
// L'enjeux est prendre en main votre éditeur de texte, d'apprendre à compiler
// et de découvrir les erreurs de compilation.
//
// Objectifs pédagogiques:
//
// - Commentaires mono-ligne et multi-lignes
// - Point d'entrer: fonction main
...
// çi dessus) elles doivent commencer par // ou être englobé par un /* */.

/* <- Ceci est aussi un commentaire.
   mais sur plusieures lignes */
...
/* En Rust on structure notre code avec des fonctions, c'est comme des mini-programmes.
  Tout programme Rust contient une fonction `main`, c'est le *point-d'entré* de notre programme.

/- `fn` est un mot clef permettant de déclarer une fonction.
|
|      /- Les parenthèses servent a indiquer si la fonction
|      |  accepte des paramètres on s'intérressera à ça plus tard.
|      |                                                                        */
fn main() {
/* ^
...
// Attention d'ailleurs une erreur de compilation existe dans une fichier source,
